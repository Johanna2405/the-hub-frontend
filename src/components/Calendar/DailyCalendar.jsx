...
const DailyCalendar = () => {
  ...
  return (
    <div className="bg-base min-h-screen mx-auto">
      ...
      {/* Day Selector */}
      <div className="flex items-center justify-between mb-8">
        <button className="btn bg-primary border-none text-lg w-10">
          &lt;
        </button>
      ...
      <div className="flex gap-2 overflow-x-auto mb-6">
        {days.map(({ day, label }) => (
          <div
            ...
            className={`flex flex-col items-center border rounded-xl px-4 py-2 cursor-pointer hover:bg-primary transition-all duration-200 w-16 min-w-[64px] ${
