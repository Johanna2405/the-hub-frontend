      ...
      <div className="flex gap-2 overflow-x-auto mb-6">
        {days.map(({ day, label }) => (
          <div
            ...
            className={`flex flex-col items-center border rounded-xl px-4 py-2 cursor-pointer transition-all duration-200 w-16 min-w-[64px] ${
              selectedDay === day ? "bg-base" : "bg-white"
            }`}
          >
